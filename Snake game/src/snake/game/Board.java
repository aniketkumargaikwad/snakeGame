...
public class Board extends JPanel implements ActionListener{
    ...
    private Image head;
    private int dots;
    private final int RANDOM_POSIION= 29;
    ...
    public void locateApple(){
        ...
        int r= (int)(Math.random()*RANDOM_POSIION);
        apple_x= (r*DOT_SIZE);
          
        r= (int)(Math.random()*RANDOM_POSIION);
        apple_y= (r*DOT_SIZE);
    }
    ...
    public void gameOver(Graphics g){
        ...
        g.setFont(font);
        g.drawString(msg, (300-metrices.stringWidth(msg))/2, 125);
        g.drawString("Score: "+(dots-3), 120, 145);
    ...
    public void draw(Graphics g){
        if(inGame){
            ...
            g.setColor(Color.WHITE);
            g.setFont(font);
            g.drawString(msg+(dots-3), (300-metrices.stringWidth(msg))/2, 20);
